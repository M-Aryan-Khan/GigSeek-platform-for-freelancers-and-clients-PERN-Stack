...
export default function ClientCompletedOrders() {
  ...
  const fetchCompletedOrders = async () => {
    try {
      ...
      const response = await axios.get(
        "http://localhost:5000/gig/client/orders/completed",
        {
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-6 mt-8 max-w-7xl">
        <h1 className="text-2xl font-bold mb-6">Your Completed Orders</h1>
