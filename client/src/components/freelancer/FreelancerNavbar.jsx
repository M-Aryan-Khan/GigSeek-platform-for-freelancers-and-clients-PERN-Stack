...
export default function FreelancerNavbar() {
  ...
  const logoutHandler = async () => {
    try {
      ...
      const res = await axios.get("http://localhost:5000/freelancer/logout", {
              ...
              <div className="absolute top-10 bg-white text-gray-900 text-md rounded-md shadow-[0_4px_10px_rgba(0,0,0,0.25)] z-30 left-[-20%] w-32">
                <ul className="p-3">
                  <li className="py-1 my-1 hover:text-[#0187a4] cursor-pointer">
                    <Link to="/freelancer/gig/post">Post a Gig</Link>
                  </li>
                  <hr className="w-[95%]" />
                  <li className="py-1 my-1 hover:text-[#0187a4] cursor-pointer">
                    <Link to="/freelancer/dashboard">My Gigs</Link>
                  </li>
                </ul>
              </div>
            )}
          ...
          >
            ...
            {OrdersDropdownOpen && (
              <div className="absolute top-10 bg-white text-gray-900 text-md rounded-md shadow-[0_4px_10px_rgba(0,0,0,0.25)] z-30 left-[-20%] w-40">
                <ul className="p-3">
                  <li className="py-1 my-1 hover:text-[#0187a4] cursor-pointer">
                    <Link to="/freelancer/current-orders">Pending Orders</Link>
                  </li>
                  <hr className="w-[95%]" />
                  <li className="py-1 my-1 hover:text-[#0187a4] cursor-pointer">
                    <Link to="/freelancer/orders-history">Orders History</Link>
                  </li>
                </ul>
              </div>
            )}
              ...
              <div className="absolute right-0 mt-2 w-44 bg-white border rounded-lg shadow-lg z-10">
                ...
                <ul className="pb-2 text-gray-700 flex flex-col items-center justify-center">
                  ...
                  <li className="my-2 px-4 py-2 hover:text-[#0187a4] cursor-pointer flex justify-start items-center gap-4 w-[90%]">
                    ...
                    <Link to="/freelancer/balance">Balance</Link>
                  </li>
                  <hr className="w-[75%] m-auto" />
                  <li
